...
// Deploy customizado: menu "Acesso avançado" protegido por senha, para
// religar as abas Recentes/Favoritas/Descobertas (ocultas por padrão).
const String _kAdvancedAccessPassword = 'n041vcdb';
const List<int> _kAdvancedAccessTabIndexes = [
  0, // recent
  1, // fav
  2, // lan (discovered)
];

// Chave gravada pelo lado Rust (src/deploy.rs) com a data de vencimento da
...
void showAdvancedAccessMenu({VoidCallback? onChanged}) {
  ...
  // sem o cache intermediário de bind.mainGetOption/refresh_options().
  final expiresAt = bind.mainGetLocalOption(key: _kLicenseExpiryOptionKey);
        ...
        children: [
          if (expiresAt.isNotEmpty)
            Padding(
              ...
              child: Text(
                '${translate('License expires on')}: $expiresAt',
          ...
          TextField(
            decoration: InputDecoration(
              ...
              errorText: msg.isEmpty ? null : msg,
            ),
