...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Failed to connect to rendezvous server", "Falha ao conectar ao servidor do MyRemote"),
        ...
        ("Failed to connect via rendezvous server", "Falha ao conectar ao servidor do MyRemote"),
