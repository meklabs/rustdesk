...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Failed to connect to rendezvous server", "Conectare la server MyRemote eșuată"),
        ...
        ("Failed to connect via rendezvous server", "Conectare prin intermediul serverului MyRemote eșuată"),
