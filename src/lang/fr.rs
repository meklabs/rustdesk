...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Failed to connect to rendezvous server", "Échec de la connexion au serveur MyRemote"),
        ...
        ("Failed to connect via rendezvous server", "Échec de la connexion via le serveur MyRemote"),
