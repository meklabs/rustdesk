...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Failed to connect to rendezvous server", "Неуспешно свързване към сървъра за среща (MyRemote)"),
        ...
        ("Failed to connect via rendezvous server", "Неуспешно свързване към сървър за срещи (MyRemote)"),
