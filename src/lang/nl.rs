...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Failed to connect to rendezvous server", "Verbinding met MyRemote-server mislukt"),
        ...
        ("Failed to connect via rendezvous server", "Verbinden via MyRemote-server mislukt"),
