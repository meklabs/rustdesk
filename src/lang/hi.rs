...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Failed to connect to rendezvous server", "MyRemote सर्वर से जुड़ने में विफल"),
        ...
        ("Failed to connect via rendezvous server", "MyRemote सर्वर के माध्यम से जुड़ने में विफल"),
