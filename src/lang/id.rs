...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Failed to connect to rendezvous server", "Gagal menghubungkan ke server MyRemote"),
        ...
        ("Failed to connect via rendezvous server", "Gagal terkoneksi via server MyRemote"),
