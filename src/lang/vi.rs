...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Failed to connect to rendezvous server", "Không thể kết nối đến máy chủ MyRemote"),
        ...
        ("Failed to connect via rendezvous server", "Không thể kết nối qua máy chủ MyRemote"),
