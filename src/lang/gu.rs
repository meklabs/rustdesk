...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Failed to connect to rendezvous server", "MyRemote સર્વર સાથે જોડવામાં નિષ્ફળ"),
        ...
        ("Failed to connect via rendezvous server", "MyRemote સર્વર દ્વારા જોડવામાં નિષ્ફળ"),
