...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Failed to connect to rendezvous server", "Lyckades inte ansluta till MyRemote-servern"),
        ...
        ("Failed to connect via rendezvous server", "Lyckades inte ansluta via MyRemote-servern"),
