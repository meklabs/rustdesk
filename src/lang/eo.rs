...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Failed to connect to rendezvous server", "Malsukcesis konekti al la servilo MyRemote"),
        ...
        ("Failed to connect via rendezvous server", "Malsukcesis konekti per servilo MyRemote"),
