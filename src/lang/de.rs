...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Failed to connect to rendezvous server", "Verbindung zum MyRemote-Server fehlgeschlagen"),
        ...
        ("Failed to connect via rendezvous server", "Verbindung über MyRemote-Server ist fehlgeschlagen"),
